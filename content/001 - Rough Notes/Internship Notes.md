...
- Checkout these resources:
	- [Summer 2026 Internships](https://github.com/vanshb03/Summer2026-Internships)
	- [Jobright](https://jobright.ai/jobs/recommend)
	- [Handshake](https://app.joinhandshake.com/inbox?filter=all)
	- Create [Simplify](https://simplify.jobs/) account. This is an extension used to autofill your data when applying
	- LinkedIn of course
	- Use this [spreadsheet](https://docs.google.com/spreadsheets/d/1nsNe_aRx_oq2KitGyJh-dGj9T5t2uw0uSNKgB5cDAEY/edit?usp=sharing) to track applications
...
- make use of [Jakes Resume Template](https://www.overleaf.com/latex/templates/jakes-resume/syzfjbzwjncs) for your resume.