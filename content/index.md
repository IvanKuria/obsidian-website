...
> **Chrome Extension:** Rate My Slugs → <https://chromewebstore.google.com/detail/ratemy-slugs/ddmahbdpmhbeohjjblfopgggdbfieboo>  
...
- **Rate My Slugs (Chrome MV3)** — Integrated **Rate My Professors** into UCSC enrollment for **700+** students; cache + fuzzy matching reduced API calls **~80%** with **<500ms** responses.
...
> [!abstract] Highlights
> **Rate My Slugs** — MV3 extension with GraphQL, caching, fuzzy name-matching, and DOM injection that blends into UCSC UI/UX.  
